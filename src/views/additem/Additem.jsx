...
import { addRecipe } from "../../store/registration/AdditemSlice";
  ...
  return (
    <div className=" dark:bg-black min-h-screen dark:text-white bg-orange-200">
      <div className="min-w-full">
        ...
        <div className="text-3xl  mt-6 mb-3 flex justify-center  text-orange-500 dark:text-white  ">
          <span className="text-4xl">
            <MdOutlineAddCircleOutline />
          </span>{" "}
          <div className="lobster-font">Add Food items</div>
        </div>
        <form
          className="border-4 rounded-md max-w-full md:mx-32 mx-2 px-2 min-h-80 dark:text-black dark:border-white  border-orange-600 text-black"
